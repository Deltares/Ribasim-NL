...
The implementation lives in [`src/peilbeheerst_model/Parametrize/scale_outlets_pumps.py`](https://github.com/Deltares/Ribasim-NL/tree/main/src/peilbeheerst_model/Parametrize/scale_outlets_pumps.py).
...
- a Ribasim model
- basin target levels in `ribasim_model.basin.area.df["meta_streefpeil"]`,
...
using `update_max_flow_rates_in_ribasim_model(...)`.
