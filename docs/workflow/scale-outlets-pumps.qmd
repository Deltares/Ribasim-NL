---
title: "Scale max flow rates outlets and pumps based on design events"
---
...
3. Open and configure `src/peilbeheerst_model/Parametrize/outlet_pump_scaler.py` from your ribasim model parametrize code.
   Set the model path, results path, initial guesses, design events, exclusions, and iteration settings.
4. Run `src/peilbeheerst_model/Parametrize/outlet_pump_scaler.py` from your ribasim model parametrize code.
