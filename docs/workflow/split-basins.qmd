...
This results in multiple manning nodes when there are multiple face, which is done on purpose as otherwise it may look like water doesn't flow between open water bodies.
