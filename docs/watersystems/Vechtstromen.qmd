...
Bij `inlaatwerk Hancate` wordt water doorgevoerd naar Salland in droge perioden, max 5.7m3/s. Deze capaciteit is nog nooit benut, normaal gesproken wordt water doorgevoerd met een maximale capaciteit van 1 tot 3 m3/s.
...
## Vriezenveen
Via inlaat `Vriezenveensche Veenkam` wordt water ingelaten vanuit `Kanaal Almelo–Haandrik` naar het `Vrienzenveensche Veenkanaal` via `aanvoergemaal Westerhaar`. Dit kanaal voert het water door naar het `Nieuwe Stroomkanaal` van waaruit het via diverse inlaten het gebied ingelaten.
...
## Dooze
Een groot deel van Dooze staat in open verbinding met het `Kanaal Almelo–Haandrik`. Via opvoergemaal `Dooze` kan water verder over het gebied worden verdeeld.
...
|:-----------------------------|:--------|----------:|:----------|-----------------:|----------------:|
| Aanvoergemaal Stokkumervlier | GM00021 |       629 | inlaat    |             0.42 |            0    |
| Aanvoergemaal Westerhaar     |         |      2341 | inlaat    |             0.88 |            0    |
| Banisgemaal                  | GM00033 |       587 | uitlaat   |             0    |           10    |
| Diepenheimse Molenbeek       | ST00558 |       411 | inlaat    |             2.61 |            0    |
| Gemaal Orveltersluis         | GM00232 |       664 | inlaat    |             0    |            1.2  |
| Hammerflier                  | ST01777 |       193 | inlaat    |             0.8  |            0    |
| Herikervlier                 | GM00181 |       560 | inlaat    |             0.14 |            0    |
| Inlaat Vroomshoop            | ST00633 |       553 | inlaat    |             1.75 |            0    |
| Oude Poelsbeek               | GM00195 |       615 | inlaat    |             0.15 |            0    |
| Sluis Aadorp                 | SL00015 |        44 | inlaat    |             8    |            0    |
| Stieltjeskanaalsluis         | SL00008 |        52 | inlaat    |             1.2 |                  |
| Stokkumervlier               | GM00003 |       642 | uitlaat   |             0    |            0.56 |
| Twicklervaart Delden         | ST02055 |       498 | inlaat    |             0.5  |            0    |
