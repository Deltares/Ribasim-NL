...
- [Laatste modelversie](https://deltares.thegood.cloud/s/RczyFnYKiCeYojW)

## Systeembeschrijving
![Systeembeschrijving Stichtse Rijnlanden](https://s3.deltares.nl/ribasim/doc-image/ribasim-nl/watersystems/StichtseRijnlanden.svg){.lightbox}
...
N.B. (!) de KWA is nu niet opgenomen in de huidige versie van het Ribasim-model!
...
- Documentatie Distributiemodel (Deel B, hoofdstuk 8)
