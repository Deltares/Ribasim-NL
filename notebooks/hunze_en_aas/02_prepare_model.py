...
cloud.synchronize(filepaths=[peilgebieden_path, hydamo_gpkg, profielen_gpkg])
...
for node_id in node_ids:
    ...
    if not peilgebieden_select_df.empty:
        ...
        elif peilgebied["hea_maximumpeil"] < 30:
            level = peilgebied["hea_maximumpeil"]
        else:
            level = None
...
# %% fixes
static_data.basin.loc[static_data.basin.node_id == 1939, "streefpeil"] = -1.27
static_data.basin.loc[static_data.basin.node_id == 1946, "streefpeil"] = -1.27
