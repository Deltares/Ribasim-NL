...
model.reverse_edge(link_id=12)
model.reverse_edge(link_id=997)
...
model.reverse_edge(link_id=224)
model.reverse_edge(link_id=1178)
...
model.reverse_edge(link_id=7)
model.reverse_edge(link_id=991)
...
# Schaphalsterzijl
model.reverse_edge(link_id=213)
model.reverse_edge(link_id=1152)
...
model.reverse_edge(link_id=519)
model.reverse_edge(link_id=1491)
...
model.reverse_edge(link_id=2033)
model.reverse_edge(link_id=2032)
