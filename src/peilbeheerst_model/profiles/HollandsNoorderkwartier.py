...
def main(
    *, export_profile_tables: bool = True, overwrite: bool = False, export_intermediate_output: bool = False
    ...
    """Execute profile table generator for Hollands Noorderkwartier.
    ...
    """
    water_authority = "HollandsNoorderkwartier"
    ...
    # > crossings
    fn_crossings = cloud.joinpath(water_authority, "verwerkt", "Crossings", "hhnk_crossings_v26.gpkg")
    gdf_crossings = gpd.read_file(fn_crossings, layer="crossings_hydroobject_filtered")
    # > hydro-objects
    fn_hydro_objects = cloud.joinpath(water_authority, "verwerkt", "Crossings", "hhnk_crossings_v26.gpkg")
