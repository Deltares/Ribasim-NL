...
print(f"{df_demand.tail(10)=}\n\n{from_to_node_function_table.tail(10)=}\n")
...
print(f"{from_to_node_function_table.tail(10)=}")
# tmp = ribasim_model.node_table().df.copy()
# print(tmp[tmp.index == 1533])
