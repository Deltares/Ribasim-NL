...
class AssignAuthorities:
    ...
    def assign_authorities(self):
        ...
        ribasim_model = self.embed_authorities_in_model(ribasim_model=self.ribasim_model, 
                                                        waterschap=self.waterschap, 
                                                        authority_borders=authority_borders)
    ...
    def embed_authorities_in_model(self, ribasim_model, waterschap, authority_borders):
        ...
        temp_LB_node = temp_LB_node.merge(right=FB_inward[['from_node_id', 'meta_to_authority']],
                                          left_on='node_id',
                                          right_on='from_node_id',
                                          how='left')
        
        temp_LB_node = temp_LB_node.merge(right=FB_outward[['to_node_id', 'meta_from_authority']],
                                          left_on='node_id',
                                          right_on='to_node_id',
                                          how='left')
        ...
        temp_LB_node = temp_LB_node.merge(right=joined[['node_id', 'naam']],
                                          on='node_id',
                                          how='left')
        ...
        ribasim_model.level_boundary.static.df = ribasim_model.level_boundary.static.df.merge(right=temp_LB_node[['node_id', 'meta_from_authority', 'meta_to_authority']],
                                                                                              on='node_id',
