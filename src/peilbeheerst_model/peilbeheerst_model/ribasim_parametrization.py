...
def identify_node_meta_categorie(ribasim_model):
    ...
    ribasim_model.pump.static.df.loc[
        ribasim_model.pump.static.df.node_id.isin(nodes_from_boezem), "meta_categorie"
    ...
    ribasim_model.pump.static.df.loc[
        ribasim_model.pump.static.df.node_id.isin(nodes_to_boezem), "meta_categorie"
    ...
    ribasim_model.pump.static.df.loc[
        ribasim_model.pump.static.df.node_id.isin(nodes_to_boundary), "meta_categorie"
...
def add_discrete_control_partswise(ribasim_model, nodes_to_control, category, sturing, default_level):
    ...
    if node_type == "outlet" or node_type == "Outlet":
        ...
        outlet_static_block[
            "min_crest_level"
        ] = np.nan  # min crest level is redundant, as control is defined for both upstream as well as downstream levels
